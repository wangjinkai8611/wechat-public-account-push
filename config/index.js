export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxc2957304040ba0ba",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "7bddbe861b10b05d4005a1bd81c4cc2a",
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "sfOxhznKYndhj_XbqD91M39Ja_yS_f6ZAVP9Plyi73o",
      // 所在省份
      province: "河南",
      // 所在城市
      city: "郑州",
      ...
      openUrl: "https://www.1212.com/luck/cancer/20220914.html",
...
//         {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2018-05-07"},
        // milky陪伴我们
     ...
     USERS: [
    {
      ...
      name: "菲菲宝宝",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "R1v0AAEsCrENs4KQIcCcM_4dXNuqwzn4odBeXG7HE7M",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "H5QXTxj1SGktkmNXaHwLKt7qshyevRGbt4_i40U7XAA",
      // 所在省份
      province: "河南",
      // 所在城市
      city: "郑州",
